...
public class FluidRegister {
    ...
    public static RegistryObject<Item> IMPURE_ALCOHOL_FLUID_BUCKET = FLUID_BUCKETS.register(UnstableFluidBlock.IMPURE_ALCOHOL_FLUID_NAME+"_bucket",() -> new BucketItem(FluidRegister.IMPURE_ALCOHOL_FLUID,new Item.Properties().tab(Groups.FLAME_REACTION_GROUP).craftRemainder(BUCKET).fireResistant()));
    ...
    public static ForgeFlowingFluid.Properties IMPURE_ALCOHOL_FLUID_PROPERTIES
            ...
            .color(new Color(200,200,200).getRGB()).density(4000).viscosity(4000))
